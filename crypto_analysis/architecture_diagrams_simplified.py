...
with Diagram("Cryptocurrency Price Prediction System Architecture", 
    ...
    with Cluster("Data Storage Layer"):
        raw_storage = Storage("Raw Data Storage")
    ...
    with Cluster("Model Layer"):
        with Cluster("Model Training"):
            bilstm = Python("Bi-LSTM Model")
            prophet = Python("Prophet Model")
            xgboost = Python("XGBoost Model")
            arima = Python("ARIMA Model")
...
with Diagram("Cryptocurrency Price Prediction Data Pipeline", 
    ...
    with Cluster("Data Sources"):
        coingecko = Python("CoinGecko API")
        binance = Python("Binance API")
        coinmarketcap = Python("CoinMarketCap API")
    ...
    with Cluster("Data Storage"):
        raw_data = Storage("Raw Data Lake")
...
with Diagram("Cryptocurrency Price Prediction Model Architecture", 
    ...
    with Cluster("Model Training Pipeline"):
        ...
        with Cluster("Model Training"):
            bilstm_train = Python("Bi-LSTM Training")
            prophet_train = Python("Prophet Training")
            xgboost_train = Python("XGBoost Training")
            arima_train = Python("ARIMA Training")
...
with Diagram("Cryptocurrency Price Prediction Deployment Architecture", 
    ...
    with Cluster("Development Environment"):
        dev_git = Python("Git Repository")
        dev_docker = Python("Docker Containers")
        dev_ci = Python("CI/CD Pipeline")
    
    with Cluster("Testing Environment"):
        test_docker = Python("Docker Compose")
